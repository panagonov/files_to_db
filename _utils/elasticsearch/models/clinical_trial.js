module.exports = {
    ...
    "schema": {
        ...
        "properties": {
            ...
            "eligibility" : {
                "type" : "object",
                "properties" : {
                    "gender": {"enum": ["female", "male", "all"]},
                    "minimum_age": {"type" : "string"},
                    "maximum_age": {"type" : "string"},
                    "min_age": {"type" : "number"},
                    "max_age": {"type" : "number"},
                    "sampling_method": {"type" : "boolean"},
    ...
    "settings": {
        "index": "bioseek-clinical_trial",
        "doc_type": "clinical_trial",
        "mapping": {
            "aliases": {
                "bioseek-clinical_trial": {}
            },
            "settings": {
                "analysis": {
                    "char_filter": {
            ...
            "mappings": {
                "clinical_trial": {
                    "properties": {
                        ...
                        "date_first_submitted"    : {"type": "date"},
                        "date_verified"           : {"type": "date"},
                        "date_last_update"        : {"type": "date"},
                        "date_last_update_posted" : {"type": "date"},
